            ...
            <Space direction="vertical horizontal">
                <Card title="Tate" style={{ padding: '1vh 1vw 1vh 1vw' }}>
                    <Space direction="horizontal">
                        <img src={tate} alt="Thumbs Up Pipboy" className="logo" style={{height:'7vh', float:'left' }} />
                ...
                <Space direction="horizontal">
                    <img src={kyle} alt="Thumbs Up Pipboy" className="logo" style={{height:'7vh', float:'left' }} />
                    <Space direction="vertical">
